...
public class Pesos {
	...
	public static double weight(int n1, int n2, Amostra A) {//Calcula o peso entre dois nós através da fórmula que o prof dá
		...
		for(i=0;i<n1Domain;i++) {
			for(j=0;j<n2Domain;j++) {
				for(k=0;k<cDomain;k++) {
					...
					//membros das divisões forem inteiros, isto evita o erro
				}
			}
		}
		return w;
